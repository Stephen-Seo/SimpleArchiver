...
3. 4 bytes bit-flags.
    ...
    2. The second byte.
        ...
        2. Reserved.
        3. The third bit is "setuid bit permission".
        4. The fourth bit is "setgid bit permission".
        5. The fifth bit is "sticky bit permission".
    3. The third byte.
        1. Currently unused.
    4. The fourth byte.
        1. Currently unused.
...
This format is mostly the same as file format 6. The difference is how
compressed data is stored on-the-fly during archival. Instead of storing a
compressed-chunk-size followed by the compressed-chunk, "chunked-encoding" is
used. One can refer to the http 1.1 standard about an existing example of
"chunked-encoding". In this case, the format for compressed data is as follows:

X-digits base-10 digits (in ascii) of size of the following "mini-chunk",
